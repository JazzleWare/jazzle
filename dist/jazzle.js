...
var cls21;
cls21 = Actix.prototype;
cls21.ii = function(inactiveIf) {
...
var cls9;
cls9 = Scope.prototype = createObj(Actix.prototype);
...
var cls5;
cls5 = ConcreteScope.prototype = createObj(Scope.prototype);
function _m(name) {
  return name + '%';
}
function _u(name) {
...
var cls1;
cls1 = BundleScope.prototype = createObj(ConcreteScope.prototype);
...
cls.setURIAndDir = function(uri, dir) {
  this.curURI = uri;
  this.curDir = dir;
};
cls.save = function(n) {
...
cls.getExistingSourceNode = function() {
  return this.resolver.loadCached(this.curURI);
};
cls.loadNewSource = function() {
  var n;
...
/* TODO: eliminate */cls1.synth_decl_find_homonym_m = function(mname) {
...
var cls14;
cls14 = Decl.prototype = createObj(Actix.prototype);
...
var cls12;
cls12 = Liquid.prototype = createObj(Decl.prototype);
...
var cls2;
cls2 = FunScope.prototype = createObj(ConcreteScope.prototype);
...
var cls6;
cls6 = CatchScope.prototype = createObj(Scope.prototype);
cls6.synth_boot = function(r) {
...
var cls7;
cls7 = ClassScope.prototype = createObj(Scope.prototype);
cls7.hasHeritage = function() {
...
var cls22;
cls22 = Comments.prototype;
cls22.push = function(comment) {
  this.c.push(comment);
  if (!this.n) {
...
cls22.mergeWith = function(another) {
  if (!this.n)
    this.n = another.n;
...
var cls23;
cls23 = LiquidGroup.prototype;
cls5.gocLG = function(gName) {
  var lg;
  lg = this.getLG(gName);
  return lg || this.createLG(gName);
};
cls5.getLG = function(gName) {
  var mname;
  mname = _m(gName);
...
cls5.synth_liquids_to = function(targetScope) {
  var list, e, len;
...
cls5.synth_lg_to = function(lg, target) {
  var list, e;
  list = lg.list;
  e = 0;
  while (e < list.length)
...
cls5.synth_name_is_valid_binding_m = function(mname) {
  return true;
};
...
cls5.synth_decl_find_homonym_m = function(mname) {
  ASSERT.call(this, this.isSourceLevel(), 'script m');
  this.isBooted || this.synth_boot(r);
  return this.findSynth_m(mname);
};
...
cls5.synthGlobal = function(global) {
...
cls5.synthLiquid = function(liquid) {
...
cls14.isReached = function() {
  return this.reached && this.reached.v;
};
cls14.refreshRSListWithList = function(list) {
  var l;
  l = 0;
  while (l < list.length)
    this.refreshRSListWith(list[l++]);
};
cls14.refreshRSListWith = function(scope) {
  var id;
  if (this.rsMap === null)
    this.rsMap = {};
  id = scope.scopeID;
...
var cls10;
cls10 = Emitter.prototype;
cls10.emitAssignment_ex = function(n, flags, isStmt) {
...
cls10.emitAssignment_binding = function(n, flags, isStmt) {
  var cb, l;
...
cls10.gu = function(guard) {
  this.insertGuard(guard);
  return this;
};
cls10.gar = function(arg) {
  this.setGuardArg(arg);
  return this;
};
cls10.gmon = function(listener) {
  this.monitorGuard(listener);
  return this;
};
cls10.grmif = function(listener) {
  this.removeGuard_if(listener);
  return this;
};
cls10.trygu = function(guard, listener) {
...
cls10.sl = function(srcLoc) {
  this.setSourceLocTo(srcLoc);
  return this;
};
cls10.eA = function(n, flags, isStmt) {
  this.emitAny(n, flags, isStmt);
  return this;
};
cls10.eH = function(n, flags, isStmt) {
  this.emitHead(n, flags, isStmt);
  return this;
};
cls10.eN = function(n, flags, isStmt) {
...
cls10.emitCondTest = function(n, prec, flags) {
  var hasParen;
  hasParen = false;
  switch (n.type) {
...
cls10.emitRenamed = function(scope, total) {
  var list, l, item;
...
cls10.emitBundleItem = function(n) {
...
cls10.emitBLE = Emitters['LogicalExpression'] = Emitters['BinaryExpression'] = function(n, flags, isStmt) {
...
cls10.emitRight = function(n, o, flags) {
...
cls10.emitLeft = function(n, o, flags) {
  var hasParen, rp, lp, cb, aft;
  hasParen = false;
  rp = bp(o);
  lp = bp(n.operator);
...
cls10.emitBLEP = function(n, flags) {
  switch (n.type) {
...
cls10.emitPow = function(n, flags, isStmt) {
  var hasParen;
  hasParen = flags & EC_NEW_HEAD;
  if (hasParen) {
    this.w('(');
...
cls10.emitAny = function(n, flags, isStmt) {
  var emitters, t;
...
cls10.writeStringValue = function(sv, ql) {
  var ch, len, c, v, vLen;
  ch = -1;
  len = sv.length;
  c = 0;
...
cls10.stringEscapeFor = function(ch) {
  switch (ch) {
  case CH_BACK_SLASH:
    return '\\\\';
  case CH_SINGLE_QUOTE:
...
cls10.writeString = function(sv, quotation) {
  this.tt(ETK_STR);
...
cls10.emitCommaList = function(list, flags) {
  var e;
  e = 0;
  while (e < list.length) {
    if (e)
...
cls10.emitStmtList = function(list) {
  var own, lsn, l;
  own = {used: false};
  lsn = this.listenForEmits(own);
  l = 0;
...
cls10.emitAttached = function(stmt) {
  var ex, own, lsn;
  switch (stmt.type) {
  case'BlockStatement':
    this.os();
...
// a, b, e, ...l -> [a,b,e],sp(l)
// a, b, e, l -> a,b,e,l
cls10.emitElems = function(list, selem/* i.e., it contains a spread element */, cb) {
  var e, em, elem, br;
  e = 0;
  em = 0;
  while (e < list.length) {
...
cls10.emitElems_toRest = function(list, s, cb) {
...
cls10.writeMemName = function(memName, asStr) {
  var cb;
  switch (memName.type) {
  case'Literal':
...
cls10.writeIDName = function(nameStr) {
  return this.writeToCurrentLine_checked(nameStr);
};
cls10.emitSAT = function(n, flags, olen) {
...
cls10.emitAccessChk_tz = function(nd, loc) {
  var scope, tz;
...
cls10.emitAccessChk_invalidSAT = function(nd, loc) {
  this.jz('cv');
  loc && this.sl(loc);
  this.w('(').writeString(nd.name, '\'');
  this.w(')');
...
cls10.emitExprFn = function(n, flags, isStmt) {
...
cls10.writeToCurrentLine_checked = function(rawStr) {
...
cls10.writeToCurrentLine_raw = function(rawStr) {
  this.emcol_cur += rawStr.length;
  this.curLine += rawStr;
};
cls10.writeToCurrentLine_space = function() {
  this.ensureNoSpace();
  if (this.guard)
...
cls10.writeToCurrentLine_virtualLineBreak = function() {
  this.ensureNoSpace();
...
cls10.emitIfBody = function(stmt) {
  var own;
  switch (stmt.type) {
  case'BlockStatement':
    this.os();
...
cls10.insertGuard = function(guard) {
...
cls10.listenForEmits = function(fallbackListener) {
  var l;
  l = null;
  if (this.guard === null) {
    l = fallbackListener;
...
cls10.removeGuard_any = function() {
  ASSERT.call(this, this.guard !== null, 'no');
  this.guard = this.guardListener = null;
};
cls10.removeGuard_if = function(listener) {
  var guardListener;
...
cls10.wrapCurrentLine = function() {
...
cls10.overflowLength = cls10.ol = function(len) {
  var wl;
  wl = this.wrapLimit;
...
cls10.writeToOut_nonLineBreak = function(str) {
  this.ensureOutActive();
  this.writeToOut_raw(str);
};
cls10.writeToOut_lineBreak = function() {
  this.ensureOutActive();
  this.emline_cur++;
  //this.emcol_cur = 0;
  this.writeToSMout(';');
...
cls10.writeToOut_raw = function(str) {
  this.out = this.out.concat(str);
  this.outLen += str.length;
};
cls10.useOut = function(use) {
  ASSERT_EQ.call(this, !this.outActive, use);
  this.outActive = use;
};
cls10.ensureOutActive = function() {
...
cls10.emitEnumeration = function(n, flags, t) {
  var b, l;
  b = t === 'dh';
  l = n.left;
  this.w('for').os().w('(');
...
Emitters['#ForOfStatement'] = function(n, flags, isStmt) {
  ...
  this.eH(n.left, EC_NONE, false).w('.').wm('next', '(', ')')//,'','||','').eH(n.left, EC_NONE, false).wm('.','end','(',')',
  .wm(';', ')');
  this.emitAttached(n.body);
};
...
cls10.flushCurrentLine = function() {
...
cls10.lineBlank = function() {
  return this.curLine.length === 0;
};
cls10.finishCurrentLine = function() {
...
cls10.adjustColumns = function(lindLen) {
...
cls10.refreshSMOutWithLM = function() {
  var lm0, lm;
  lm0 = '';
  lm = this.lm;
  if (this.hasRecorded_SMLinkpoint) {
...
Emitters['#-ResolvedName.ex'] = cls10.emitRName_ex = Emitters['#-ResolvedName.sat'] = cls10.emitRName_SAT = function(n, flags, isStmt) {
...
Emitters['#-ResolvedName.binding'] = cls10.emitRName_binding = function(n, flags, isStmt) {
  var cb;
...
cls10.emitSourceHead = function(n) {
  var scope, em;
  scope = n['#scope'];
  em = 0;
...
cls10.emitSimpleHead = function(n) {
  var scope, em;
  scope = n['#scope'];
  em = 0;
...
cls10.emitVarList = function(scope, hasPrev) {
...
cls10.emitTempList = function(scope, hasPrev) {
...
cls10.emitFunLists = function(scope, allowsDecl, hasPrev) {
...
cls10.emitLLINOSAList = function(scope, hasPrev) {
  var list, i, len, em, own, elem;
...
cls10.emitFunList_subList = function(funList, allowsDecl, hasPrev) {
  var i, em, own, lsn;
  i = 0;
  em = 0;
  own = {used: false};
...
cls10.emitThisRef = function(scope, hasPrev) {
  var th, own;
  th = scope.spThis;
  if (th === null) {
    return 0;
...
cls10.emitSingleFun = function(n, allowsDecl, i, hasPrev) {
...
cls10.emitTCheckVar = function(scope, hasPrev) {
  var tg, own;
  tg = scope.getLG('tz');
  if (tg === null) {
    return 0;
...
cls10.emitTransformedArgs = function(n, hasPrev) {
  var ta, b, own;
  ta = n.argsPrologue;
  if (ta === null) {
    return 0;
...
cls10.emitTCHP = function(scope, hasPrev) {
  var tg, own;
...
cls10.emitArgumentsRef = function(scope, hasPrev) {
  var ar, own;
...
cls10.emitThisChk = function(scope, hasPrev) {
  var ti, own;
  ti = scope.getLG('ti');
  if (ti === null) {
    return 0;
...
cls10.emitJ = function(scope, hasPrev) {
  var own, u, o;
  return 0;
  own = false;
  u = null;
...
cls10.smSetName_str = function(name) {
  var nc, mname, list;
  nc = -1;
  if (name.length) {
    mname = _m(name);
...
cls10.smSetSrc_str = function(srcName) {
  var sc, mname, list;
  sc = -1;
  if (srcName.length) {
    mname = _m(srcName);
...
cls10.writeToSMout = function(lm) {
  this.sm = this.sm.concat(lm);
  if (this.inMapping)
    this.smLen += lm.length;
};
cls10.refreshTheCurrentLineLevelSourceMapWith = function(srcLoc) {
  var l, vlqTail, ll, lm;
  l = 0;
  vlqTail = '';
  l = this.srci_cur;
...
cls10.setSourceLocTo = function(srcLoc) {
  ASSERT.call(this, srcLoc, 'lw');
  this.pendingSrcLoc = srcLoc;
};
cls10.findIndentStringWithIdealLength = function(idealLength) {
...
cls10.indentNextLine = function() {
  this.nextLineIndent++;
};
cls10.unindentNextLine = function() {
  ASSERT.call(this, this.nextLineIndent > 0, 'line has a <1 indent');
  this.nextLineIndent--;
};
cls10.emitMemex = function(n, flags, isStmt, len) {
  var cb;
  cb = CB(n);
  this.emc(cb, 'bef');
  //this.sl(n.loc.start);
...
cls10.emitSAT_mem = function(n, flags, len) {
...
cls10.removePendingSpace_try = function() {
  return this.hasPendingSpace() ? this.removePendingSpace() : SP_NONE;
};
cls10.notJustAfterLineBreak = function() {
...
cls10.emitTransformedFn = function(n, flags, isStmt) {
...
var cls17;
cls17 = Transformer.prototype;
cls10.writeJZHelpers = function() {
...
cls19 = ErrorString.prototype;
cls19.applyTo = function(obj) {
...
cls2.setRefsAndArgRefs = function(refs) {
  var len, e;
...
cls2.getNonLocalLoopLexicals = function() {
...
cls2.handOver_m = function(mname, ref) {
  if (!this.isArrow()) {
...
cls2.refInHead = function(mname, ref) {
  if (!this.isArrow()) {
    if (ref_this_m(mname)) {
...
cls2.spCreate_arguments = function(ref) {
  var spArguments;
...
cls2.spCreate_scall = function(ref) {
  var lg, spSuperCall;
...
cls2.synth_ref_may_escape_m = function(mname) {
  return !ref_arguments_m(mname);
};
cls2.synth_name_is_valid_binding_m = function(mname) {
  return true;
};
cls2.synth_ref_find_homonym_m = function(mname, r) {
  var synth;
  this.isBooted || this.synth_boot(r);
...
cls2.synth_decl_find_homonym_m = function(mname, r) {
  this.isBooted || this.synth_boot(r);
  return this.findSynth_m(mname);
};
cls2.synth_boot = function(r) {
  if (this.renamer === null)
    this.renamer = r;
  this.synth_boot_init();
...
cls2.verifyForStrictness = function() {
  var list, i, elem;
...
cls2.verifyUniqueArgs = function() {
...
var cls3;
cls3 = GlobalScope.prototype = createObj(ConcreteScope.prototype);
/* TODO: eliminate */cls3.synth_decl_find_homonym_m = function(mname) {
  return this.findSynth_m(mname);
};
function Ref(scope) {
  this.i = 0;
...
var cls8;
cls8 = ParenScope.prototype = createObj(Scope.prototype);
cls8.finish = function() {};
cls8.makeParams = function(paramScope) {
  paramScope.setRefsAndArgRefs(this.refs);
  this.updateParentForSubScopesTo(paramScope);
  this.hasDissolved = true;
};
cls8.makeSimple = function() {
...
cls8.updateParentForSubScopesTo = function(sParent) {
  var list, i, elem;
  list = this.ch;
  i = 0;
  while (i < list.length) {
...
cls18.parseCond = function(cond, ctx) {
  var seq, alt;
...
cls18.ensureSpreadToRestArgument_soft = function(head) {
  return head.type !== 'AssignmentExpression';
};
cls18.parseExpr = function(ctx) {
...
cls18.readNum_octLegacy = function(ch) {
  var c, s, l, dec;
...
cls18.readNum_tail = function(fl) {
...
cls18.regMakeSurrogate = function(c1, c2) {
...
cls18.regSurrogateComponent_VOKE = function(cp, offset, kind, escape) {
  var c0, loc0;
  c0 = this.c;
  loc0 = this.loc();
...
cls18.parseSwitchCase = function() {
...
cls18.parseImport_slist = function(list) {
...
cls18.parseImport_namespace = function() {
...
cls18.parseExprHead = function(ctx) {
  var head;
  head = this.exprHead;
  if (head !== null)
    this.exprHead = null;
...
cls18.parseAssignment = function(head, ctx) {
...
cls18.parseStatement = function(allowNull) {
...
cls18.inferName = function(left, right, isComputed) {
...
cls18.cutEx = function() {
  var ex;
  ex = this.ex;
  this.ex = DT_NONE;
  return ex;
};
cls18.readOp_and = function() {
  var c, ch;
  c = this.c;
  c++;
  ch = this.scat(c);
...
cls18.regCurlyQuantifier = function() {
...
cls18.regQuantify = function(elem) {
...
cls18.parseMeth = function(memName, ctx, st) {
...
cls18.resetLastRegexElem = function() {
  var lbe;
...
cls18.regTryToParseNum = function() {
  var c, s, l, v, ch;
  c = this.c;
  s = this.src;
  l = this.regLastOffset;
...
cls18.parseClass = function(ctx) {
  ...
  eloc = this.loc();
  n = {type: isStmt ? 'ClassDeclaration' : 'ClassExpression', id: name, start: c0, end: this.c, superClass: superClass && core(superClass), loc: {start: loc0, end: eloc}, body: {type: 'ClassBody', loc: {start: loc0b, end: eloc}, start: c0b, end: this.c, body: list, '#y': y, '#c': cbb}, '#y': (superClass ? this.Y(superClass) : 0) + y, '#scope': scope, '#c': cb, '#ct': ct};
  this.suc(cbb, 'inner');
...
cls18.parseMeta = function(c0, loc0, c, li, col) {
  var cb, prop;
  cb = this.cb;
...
cls18.parseEmptyStatement = function() {
  var n;
...
cls18.parseNonSeq = function(prec, ctx) {
...
cls18.parseMem = function(ctx, st) {
...
cls18.parseNonMethObjMem = function(memName, ctx) {
...
cls18.readBS_lcurly = function(c) {
  var s, l, val, b, t;
  s = this.src;
  l = s.length;
  c++;
...
cls18.regEsc_uCurly = function(ce) {
...
cls18.fixupLabels = function(isLoop) {
  if (this.unsatisfiedLabel) {
    this.unsatisfiedLabel.loop = isLoop;
    this.unsatisfiedLabel = null;
  }
};
cls18.stmtList = function() {
...
// TODO: eliminate
cls18.fixupLabel = function(label, isLoop) {
  label.loop = isLoop;
};
cls18.parseFor = function() {
...
cls18.ensureVarsAreNotResolvingToCatchParams = function() {
  return;
};
cls18.expectT = function(lttype) {
...
cls18.rw = function(c, li, col, luo) {
  this.c = c;
  this.li = li;
  this.col = col;
  this.luo = luo;
...
cls18.c0_to_c = function() {
  return this.src.substring(this.c0, this.c);
};
cls18.toAssig = function(head, context) {
  var i, list;
  if (head === this.ao)
    this.throwTricky('a', this.at, this.ae);
  i = 0;
...
cls18.parseVar = function(dt, ctx) {
...
cls18.regTryMix = function(list, elem) {
  var last;
  if (list.length === 0) {
    return elem;
  }
...
cls18.parseLabel = function(label, allowNull) {
...
cls18.parseUpdate = function(arg, ctx) {
  var c, loc, u, uc;
  c = 0;
  loc = null;
  u = this.ltraw;
...
cls18.readOp_compl = function() {
  this.lttype = TK_UNARY;
  this.ltraw = '~';
  this.setsimpoff(this.c + 1);
};
cls18.parseTail = function(head) {
...
cls18.parseTryStatement = function() {
...
cls18.parseDependent = function(name) {
  var c0, cb, loc0, n;
  c0 = this.c0;
  cb = {};
  loc0 = this.loc0();
...
cls18.regChar_VECI = function(value, offset, ch, ce) {
...
cls18.readID_simple = function() {
  this.ct = ERR_NONE_YET;
  return this.readID_withHead(this.src.charAt(this.c++));
};
cls18.parseString = function(startChar) {
...
cls18.read_multiQ = function() {
  this.lttype = CH_MULTI_QUOTE;
  this.ltraw = '\"';
  this.setsimpoff(this.c + 1);
};
cls18.read_singleQ = function() {
  this.lttype = CH_SINGLE_QUOTE;
  this.ltraw = '\'';
  this.setsimpoff(this.c + 1);
};
cls18.parseTemplate = function() {
...
cls18.parseCatchClause = function() {
...
cls18.asArrowFuncArgList = function(argList) {
  var i, list;
  i = 0;
  list = argList;
  while (i < list.length)
...
cls18.asArrowFuncArg = function(arg) {
  var i, list;
  i = 0;
  list = null;
  if (arg === this.po)
...
cls18.parseExport_elemOther = function(c0, loc0) {
  var elem, cb, stmt;
  elem = null;
  cb = this.cb;
  stmt = false;
...
cls18.parseExport_elemList = function(c0, loc0) {
...
cls18.parseExport_elemAll = function(c0, loc0) {
  var cb, src;
  cb = this.cb;
  this.suc(cb, '*.bef');
  this.next();
...
cls18.createDefaultLiq = function() {
  var lg, liqDefault;
...
cls18.parseExport_elemDefault = function(c0, loc0) {
...
cls18.parseExport_from = function() {
  var cb;
  cb = this.cb;
...
cls18.parseExport_elemDefault_async = function() {
  var a;
  a = this.id();
  // 'async'
  if (this.nl) {
...
cls18.regUnitAssertion = function() {
  var c0, loc0, kind;
  c0 = this.c;
  loc0 = this.loc();
...
cls18.enterPrologue = function() {
  this.scope.enterPrologue();
};
cls18.exitPrologue = function() {
  this.scope.exitPrologue();
  this.clearPendingStrictErrors();
};
cls18.applyDirective = function(directiveLiteral) {
  var raw;
...
cls18.parseArrow = function(arg, ctx) {
...
cls18.dissolveParen = function() {
  if (this.parenScope) {
    this.parenScope.makeSimple();
    this.parenScope = null;
  }
};
cls18.parseDbg = function() {
...
cls18.readSurrogateTail = function() {
...
cls18.readID_surrogate = function(sc) {
...
cls18.parsePat_assig = function(head) {
  var e;
  if (this.v <= 5)
    this.err('ver.assig');
  this.spc(head, 'aft');
...
cls18.throwTricky = function(name, t) {
  var core;
  core = name === 'p' ? this.pe : name === 'a' ? this.ae : this.se;
  this.err(tm[t], {tn: core});
};
cls18.pt_teot = function(t, e, o) {
  this.pt = t;
  this.pe = e;
  this.po = o;
};
cls18.at_teot = function(t, e, o) {
  this.at = t;
  this.ae = e;
  this.ao = o;
};
cls18.st_teot = function(t, e, o) {
  this.st = t;
  this.se = e;
  this.so = o;
};
cls18.st_adjust_for_toAssig = function() {
  if (this.st === ERR_ARGUMENTS_OR_EVAL_ASSIGNED)
    this.st = ERR_ARGUMENTS_OR_EVAL_DEFAULT;
  else
    this.st = ERR_NONE_YET;
};
cls18.pin_at = function(c0, li0, col0) {
  return this.pinErr(this.pin.a, c0, li0, col0);
};
cls18.pin_ct = function(c0, li0, col0) {
  return this.pinErr(this.pin.c, c0, li0, col0);
};
cls18.pin_st = function(c0, li0, col0) {
  return this.pinErr(this.pin.s, c0, li0, col0);
};
cls18.pin_pt = function(c0, li0, col0) {
  return this.pinErr(this.pin.p, c0, li0, col0);
};
cls18.pinErr = function(pin, c0, li0, col0) {
  pin.c0 = c0;
  pin.li0 = li0;
  pin.col0 = col0;
};
cls18.strict_esc_chk = function() {
...
cls18.readID_withHead = function(v) {
...
cls18.regEsc_simple = function(v, ce) {
  return this.regChar_VECI(v, this.c + 2, v.charCodeAt(0), ce);
};
cls18.regEsc_control = function(ce) {
  var c0, c, s, l, ch;
  c0 = this.c;
  c = c0;
  s = this.src;
...
cls18.regEsc_itself = function(ch, ce) {
  var c, s;
  c = this.c;
  s = this.src;
  c++;
...
cls18.regEsc_num = function(ch, ce) {
...
// TODO: strict-chk
cls18.regEsc_legacyNum = function(ch, ce) {
  var c, s, l, max, num;
  c = this.c;
  s = this.src;
  l = this.regLastOffset;
...
cls18.handleLet = function(letID) {
...
cls18.parseRegexLiteral = function() {
...
cls18.setPatCheck = function(shouldCheck) {
  if (shouldCheck) {
    this.vpatCheck = true;
    this.vpatErr = PE_NONE;
  }
};
cls18.parseArgList = function() {
...
cls18.parseSpread = function(ctx) {
  var c0, cb, loc0, arg;
  this.v <= 5 && this.err('ver.spread.rest');
  c0 = this.c0;
  cb = {};
...
cls18.augmentCB = function(n, i, c) {
  var cb;
  if (c === null) {
    return;
  }
...
cls18.suc = function(cb, i) {
  cb[i] = this.cc();
};
cls18.spc = function(n, i) {
  var cb;
  cb = CB(n);
  cmn_ac(cb, i, this.cc());
};
cls18.parseObj = function(ctx) {
...
var cls4;
cls4 = SourceScope.prototype = createObj(ConcreteScope.prototype);
cls18.parseProgram = function() {
...
cls18.enterScope = function(scope) {
  this.scope = scope;
};
cls18.exitScope = function() {
  var scope;
  scope = this.scope;
  scope.finish();
...
cls18.allow = function(allowedActions) {
  this.scope.actions |= allowedActions;
};
cls18.isResv = function(name) {
  switch (name.length) {
  case 1:
    return false;
  case 2:
...
cls18.validate = function(name) {
  this.isResv(name) && this.ri();
};
cls18.parsePat_obj = function() {
...
cls18.parseAsync_otherID = function(asyncID, ctx) {
  var id, n;
  this.cutEx();
  if (this.nl) {
    return asyncID;
...
cls18.parseAsync_exprHead = function(asyncID, ctx) {
...
cls18.parseAsync_fn = function(asyncID, ctx) {
  var asyncFn;
  if (this.nl) {
    return asyncID;
  }
...
cls18.parseAsync = function(asyncID, ctx) {
  if (this.peekID('function')) {
...
var set1 = function set(newErrorType, existingErrorType) {
  var builder;
...
var ErrorBuilders;
cls18.onErr = function(errorType, errParams) {
...
cls18.buildErrorInfo = function(builder, params) {
...
set1('block.dependent.is.unfinished', '<unfinished>', 'try { 12');
...
set1('block.unfinished', '<unfinished>');
...
set1('call.args.is.unfinished', '<unfinished>');
...
set1('class.unfinished', '<unfinished>');
...
set1('export.named.not.id.from', 'export.all.no.from');
set1('export.named.source.not.str', 'export.all.source.not.str');
...
set1('for.simple.no.end.paren', 'for.iter.no.end.paren');
a('for.simple.no.init.semi', {m: 'a ; was expected; got {parser.lttype}'}, 'for (a 12 b; 12) break;');
set1('for.simple.no.test.semi', 'for.simple.no.init.semi');
set1('for.with.no.opening.paren', '<opening>');
// TODO: precision
a('func.args.has.dup', {tn: 'tn', m: '{tn.name}: duplicate params are not allowed'}, 'function l([a,a]) {}');
set1('func.args.no.end.paren', '<closing>');
set1('func.args.no.opening.paren', '<opening>');
...
set1('if.has.no.closing.paren', '<closing>');
set1('if.has.no.opening.paren', '<opening>');
...
set1('import.specifier.local.not.id', 'import.namespace.specifier.local.not.id');
set1('import.specifier.no.as', 'import.namespace.specifier.no.as');
a('incdec.post.not.simple.assig', {m: 'member expression or identifier expected -- got {tn.type}'}, '[a]--');
set1('incdec.pre.not.simple.assig', 'incdec.post.not.simple.assig');
...
set1('pat.array.is.unfinished', 'array.unfinished');
...
set1('prop.dyna.no.expr', 'prop.dyna.is.unfinished');
// TODO: precision
...
cls18.regPushClassElem = function(list, tail) {
...
cls18.regTryCompleteSemiRange = function() {
  var sr;
  sr = this.regSemiRange;
...
cls18.regPeek = function(notInverse) {
...
cls18.parseRegex = function(rc, rli, rcol, regLast, nump, flags, /* tail (flags) */tc, tli, tcol) {
...
cls18.readComment_line = function() {
...
cls18.readComment_multi = function() {
...
cls18.foundComment = function(c0, li0, col0, l0o, t) {
...
cls18.parseIDExprHead = function(ctx) {
  var name;
  name = this.ltval;
  SWITCH:
  switch (name.length) {
...
cls18.setsimpoff = function(offset) {
...
cls18.setzoff = function(offset) {
  this.luo = offset;
  this.c = offset;
  this.col = 0;
  this.li++;
};
cls18.scat = function(offset) {
  return offset < this.src.length ? this.src.charCodeAt(offset) : -1;
};
cls18.parseParams = function(argLen) {
...
cls18.readDiv = function() {
  this.lttype = CH_DIV;
  this.setsimpoff(this.c + 1);
};
function PathMan() {}
var cls25;
cls25 = PathMan.prototype;
cls25.isSlash = function(path, at) {
  return path.length <= at ? false : path.charCodeAt(at) === CH_DIV;
};
cls25.findSlash = function(path, at) {
  ASSERT.call(this, arguments.length === 2, 'arguments');
  return path.indexOf('/', at);
};
cls25.findLastSlash = function(path, at) {
  ASSERT.call(this, arguments.length === 2, 'arguments');
  return path.lastIndexOf('/', at);
};
// tail(a/b) -> b; tail(a) -> ""
cls25.tail = function(path) {
  var slash;
...
cls24.absorbDirect = function(ref) {
  return this.absorb(ref, true);
};
cls24.absorbIndirect = function(ref) {
  return this.absorb(ref, false);
};
cls24.absorb = function(childRef, refD) {
...
cls24.updateStats = function(d, i) {
  this.d += d;
  this.i += i;
};
cls24.getDecl_nearest = function() {
  var ref;
...
cls24.getDecl_real = function() {
  return this.getDecl_nearest().getDecl_real();
};
cls24.assigned = function() {
  var targetRef;
...
var cls13;
cls13 = ScopeName.prototype = createObj(Decl.prototype);
cls13.hasName_m = function(mname) {
...
cls9.setName = function(name, source) {
...
cls9.getThisBase = function() {
  return this.scs;
};
cls9.pushFun = function(name, transformedFn) {
  var mname, list;
...
cls9.owns = function(nd) {
  return nd.ref.scope === this/* && (!nd.isImported()) */;
};
cls9.determineFlags = function() {
  var fl;
  if (this.isParen()) {
...
cls9.spCreate_this = function(ref) {
  var spThis;
...
cls9.handOverRefList = function(list) {
  var len, i, ref, mname;
  len = list.length();
  i = 0;
  while (i < len) {
...
cls9.handOver_m = function(mname, ref) {
...
cls9.deactivateBody = function() {
  ASSERT.call(this, this.hasHead(), 'a scope with a head was expected');
  ASSERT_EQ.call(this, this.inBody, true);
  this.inBody = false;
  this.refs = this.argRefs;
};
cls9.makeStrict = function() {
  this.flags |= SF_STRICT;
  if (this.isAnyFn())
    this.verifyForStrictness();
};
cls9.refDirect_m = function(mname, childRef) {
  var ref;
...
cls9.findRefU_m = cls9.fRo_m = function(mname) {
  return this.refs.has(mname) ? this.refs.get(mname) : null;
};
cls9.findRefAny_m = cls9.fRa_m = function(mname) {
  var ref, tdecl;
...
cls9.removeRefU_m = function(mname) {
  var ref;
  ref = this.findRefU_m(mname);
  if (ref)
...
cls9.focRefAny_m = cls9.focRa_m = function(mname) {
  var ref;
...
cls9.insertRef_m = function(mname, ref) {
  this.refs.set(mname, ref);
};
cls9.refIndirect_m = function(mname, childRef) {
  var ref;
  ref = this.focRefAny_m(mname);
...
cls9.hasNewTarget = function() {
  return this.allowed & SA_NEW_TARGET;
};
cls9.hasHead = function() {
  return this.isAnyFn() || this.isCatch();
};
cls9.hasSignificantNames = function() {
...
cls9.enterForInit = function() {
  this.flags |= SF_FORINIT;
};
cls9.enterPrologue = function() {
  this.flags |= SF_INSIDEPROLOGUE;
};
cls9.exitForInit = function() {
  ASSERT.call(this, this.insideForInit(), 'must be in a for');
  this.flags &= ~SF_FORINIT;
};
cls9.exitPrologue = function() {
  this.flags &= ~SF_INSIDEPROLOGUE;
};
cls9.canSmem = function() {
  return this.actions & SA_MEMSUPER;
};
cls9.canAwait = function() {
  return this.actions & SA_AWAIT;
};
cls9.canBreak = function() {
  return this.actions & SA_BREAK;
};
cls9.canDeclareLexical = function() {
...
cls9.canScall = function() {
  return this.actions & SA_CALLSUPER;
};
cls9.canDeclareFn = function(st) {
  if (this.isBlock() || this.isModule() || this.isScript()) {
    return true;
  }
  if (this.isAnyFn() || this.isCatch()) {
...
cls9.canYield = function() {
  return this.actions & SA_YIELD;
};
cls9.canMakeThis = function() {
  if (this.isAnyFn()) {
    return !this.isArrow();
  }
  return this.isSourceLevel();
};
cls9.canReturn = function() {
  return this.actions & SA_RETURN;
};
cls9.canContinue = function() {
  return this.actions & SA_CONTINUE;
};
cls9.canAccessNewTarget = function() {
  return this.actions & SA_NEW_TARGET;
};
cls9.canHaveName = function() {
  return this.isAnyFn() || this.isClass();
};
cls9.declareHoisted_m = function(mname, t) {
...
cls9.findDeclOwn_m = function(mname) {
  var tdecl;
  tdecl = this.findDeclAny_m(mname);
...
cls9.findDeclAny_m = function(mname) {
...
cls9.hoistName_m = function(mname, tdecl, tscope, isNew) {
  var cur, existing;
  cur = this;
  while (true) {
...
cls9.findParam_m = function(mname) {
...
cls9.declareLexical_m = function(mname, t) {
...
cls9.decl_let_m = function(mname, t) {
  return this.declareLexical_m(mname, t);
};
cls9.decl_fn_m = function(mname, t) {
  return this.isLexicalLike() ? this.declareLexical_m(mname, t) : this.declareHoisted_m(mname, t);
};
cls9.decl_const_m = function(mname, t) {
  return this.declareLexical_m(mname, t);
};
cls9.decl_var_m = function(mname, t) {
  return this.declareHoisted_m(mname, t);
};
cls9.decl_cls_m = function(mname, t) {
  return this.declareLexical_m(mname, t);
};
cls9.decl_catchArg_m = function(mname, t) {
  var existing, newDecl;
...
cls9.decl_fnArg_m = function(mname, t) {
...
cls9.insertDecl_m = function(mname, newDecl) {
  this.defs.set(mname, newDecl);
};
cls9.insideIf = function() {
  return this.flags & SF_INSIDEIF;
};
cls9.insideLoop = function() {
  return this.flags & SF_LOOP;
};
cls9.insideStrict = function() {
  return this.flags & SF_STRICT;
};
cls9.insidePrologue = function() {
  return this.flags & SF_INSIDEPROLOGUE;
};
cls9.insideForInit = function() {
  return this.flags & SF_FORINIT;
};
cls9.insideArgs = function() {
  return this.isAnyFn() && !this.inBody;
};
cls9.spReportGlobal_m = function(mname, ref) {
  var globalBinding;
...
cls9.insertGlobal_m = function(mname, global) {
...
cls9.findGlobal_m = function(mname) {
  var global;
  global = null;
...
cls11.get = function(name) {
  return this.obj[name];
};
cls11.remove = function(name) {
  var list, i;
  if (!HAS.call(this.obj, name)) {
    return false;
  }
...
cls11.has = function(name) {
  return HAS.call(this.obj, name);
};
cls11.length = function() {
  return this.keys.length;
};
cls11.pop = function(out) {
  var list, name, elem;
  list = this.keys;
...
cls4.forwardsSource = function(src) {
  return this.allSourcesForwarded.has(_m(src));
};
cls4.fillForwardedSourceEntryWith = function(fw, scope) {
  var mname;
  mname = _m(fw);
...
cls4.regulateForwardExportList = function(list, src) {
...
cls4.regulateForwardExport = function(ex, sourceImported) {
  var entry, nd;
  entry = ex['#entry'];
...
cls4.regulateOwnExportList = function(list) {
  var l;
  l = 0;
  while (l < list.length)
    this.regulateOwnExport(list[l++]['#entry']);
};
cls4.regulateOwnExport = function(entry) {
  var mname, nd;
...
cls4.registerForwardedSource = function(src) {
  var mname;
  mname = _m(src.value);
...
cls4.refreshUnresolvedExportsWith = function(n) {
...
cls4.registerExportedEntry_oi = function(outerName, outerID, innerName) {
...
cls4.focUnresolvedExportedTarget = function(name) {
...
cls4.regulateImports_sl = function(src, list) {
...
cls4.addImportedAlias_ios = function(inner, outer, sourceImported) {
  var aliases;
  aliases = this.gocAliasesImported(sourceImported, outer);
  aliases.push(inner);
};
cls4.gocSourceImported = function(src) {
  var mname, im;
  mname = _m(src);
...
cls4.declareImportedName = function(id, t) {
...
cls4.gocAliasesImported = function(sourceImported, outerName) {
  var mname;
  mname = _m(outerName);
  return sourceImported.has(mname) ? sourceImported.get(mname) : sourceImported.set(mname, []);
};
cls4.createImportedBinding = function(id, t) {
  var nd;
  nd = new Decl();
  nd.t(t).s(id).n(id.name);
  return nd;
};
cls4.satisfyWithBundler = function(bundler) {
...
cls4.satisfyEntries = function(list) {
...
cls4.satisfyBindingWithName = function(binding, name) {
  var ex;
...
cls4.searchInOwnExports = function(name) {
  var mname, entry;
  mname = _m(name);
  entry = this.allNamesExported.has(mname) ? this.allNamesExported.get(mname) : null;
  if (entry) {
...
cls4.searchExports = function(name, soFar) {
  var ex;
...
cls4.searchInForwardedExports = function(name, soFar) {
...
cls4.resolve1to2 = function(slave, master) {
...
cls4.registerImportedScope = function(uri, scope) {
  var mname;
  mname = _m(uri);
...
cls20.applyTo = function(obj, noErrIfUndefNull) {
...
cls17.trArrayElem = function(left, iter, at, isB, cbn) {
...
cls17.trObjElem = function(elem, iter, isB) {
  var name, right, left;
  name = elem.key;
  if (elem.computed)
...
cls17.needsCVLHS = function(decl) {
  var tc;
  if (!decl.isImmutable()) {
    return false;
  }
...
cls17.cacheCVLHS = function(decl) {
  var tc;
  tc = this.getTCCache(decl);
  if (tc)
...
cls17.setCVTZ = function(cvtz) {
  var l;
  l = this.cvtz;
  this.cvtz = cvtz;
  return l;
};
cls17.setRR = function(reachedRef) {
  var rr;
  rr = this.reachedRef;
  this.reachedRef = reachedRef;
  return rr;
};
cls17.setScope = function(scope) {
  var cur;
  cur = this.cur;
  this.cur = scope;
  return cur;
};
cls17.setTS = function(ts) {
  var ts0;
  ts0 = this.tempStack;
  this.tempStack = ts;
  return ts0;
};
cls17.setThis = function(thisState) {
  var th;
  th = this.thisState;
  this.thisState = thisState;
  return th;
};
cls17.tr = function(n, isVal) {
...
cls17.transformBundleItem = function(n) {
  var list, len, l;
  list = n['#imports'];
  len = list ? list.length : 0;
  l = 0;
...
cls17.trListChunk = function(list, isVal, s, e) {
  while (s <= e) {
    if (list[s] !== null)
...
cls17.trList = function(list, isVal) {
  return this.trListChunk(list, isVal, 0, list.length - 1);
};
cls17.transformCls = function(n, isVal, oBinding) {
...
cls17.transformCtor = function(ctor, oBinding, r) {
...
cls17.transformMem = function(mem, oBinding, r) {
...
cls17.syntheticCtor = function(cls, heritage) {
...
cls17.synth_Temp = function(liq) {
  return {kind: 'temp', occupied: 0, liq: liq, type: '#Untransformed', '#c': {}, loc: null};
};
cls17.synth_TempSave = function(t, expr) {
...
cls17.synth_node_BinaryExpression = function(left, o, right, y) {
  return {left: left, operator: o, right: right, type: 'BinaryExpression', '#y': y || 0, '#c': {}};
};
cls17.synth_Void0 = function() {
  return SYNTH_VOID0;
};
cls17.synth_SynthName = function(liq) {
  return {type: '#Untransformed', kind: 'synth-name', liq: liq, '#c': {}};
};
cls17.synth_node_MemberExpression = function(n, v) {
  return {loc: null, computed: true, object: n, property: v, '#y': 0, '#c': {}, type: 'MemberExpression'};
};
cls17.synth_TransformedFn = function(n, a) {
...
cls17.synth_GlobalUpdate = function(assig, isU) {
  return {isU: isU, kind: 'global-update', assig: assig, type: '#Untransformed', '#c': {}};
};
cls17.synth_SynthLiteral = function(l) {
  switch (l.type) {
  case'Literal':
    return l;
  case'Identifier':
...
cls17.synth_Skip = function() {
  return SKIP;
};
cls17.synth_ResolvedThis = function(src, th, chk) {
  var simp;
...
cls17.transformRawFn = function(n, isVal) {
...
cls17.transformDeclFn = function(n) {
  var target;
  target = tg(n.id);
...
cls17.transformExprFn = function(n) {
  var sn;
...
cls17.transformParams = function(list) {
...
cls17.transformParamsToArgumentsPrologue = function(list) {
...
cls17.synthFnExprName = function(fnName) {
...
cls17.trSAT_mem = Transformers['MemberExpression'];
cls17.getTCCache = function(decl) {
  var mname;
...
cls17.needsTZ = function(decl, isImported) {
...
cls17.makeReached = function(target) {
  ASSERT.call(this, target.reached === null, 'reached used');
  target.reached = this.reachedRef;
};
cls17.toResolvedName = function(id, bes, manualActivation) {
  ...
  isB = bes === 'binding';
  hasTZ = !isB && this.needsTZ(target, ref.getDecl_nearest().isImported());
  if (hasTZ) {
...
cls17.getDeclFor = function(name, isB) {
  var target, ref;
...
cls17.trSAT_name = function(n, isVal) {
...
cls17.ac = function(to, name, from) {
  if (from === null) {
    return;
  }
...
cls17.transformDtor = function(n, kind) {
...
cls17.transformCatch = function(n) {
  var a, s;
  a = null;
  s = this.setScope(n['#scope']);
...
cls17.transformCatchArgs = function(n) {
  var l;
...
var cls15;
cls15 = VirtualResourceResolver.prototype = createObj(ResourceResolver.prototype);
cls15.asNode = function(uri) {
  var newParser;
...
cls15.has = function(uri) {
  return HAS.call(this.fsMap, _m(uri));
};
cls15.set = function(uri, value) {
...
cls16 = FileResourceResolver.prototype = createObj(RRcls);
;
cls16.asNode = function(uri) {
  var src, newParser, n;
  uri = normalize(uri);
...
cls16.hasInCache = function(uri) {
  uri = normalize(uri);
  return RRcls.hasInCache.call(this, uri);
};
cls16.loadCached = function(uri) {
  uri = normalize(uri);
  return RRcls.loadCached.call(this, uri);
};
cls16.cache = function(uri, n) {
  uri = normalize(uri);
  return RRcls.cache.call(this, uri, n);
};
cls16.loadNew = function(uri) {
  uri = normalize(uri);
